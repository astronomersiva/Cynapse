			...
			<div class="row">
				...
				<div class="col-xs-10 col-sm-5 col-lg-5">
					<div class="intro">
						...
						<form class="form-signin" method="post" id='signin' name="signin" action="test.php">
							...
							<div class="form-group">
                                ...
                                <select class="form-control" name="category" id="category">
                                  <option value="">Choose the test</option>
                                  <?php
						...
						<?php }else{?>
                            ...
                            <div class="form-group">
                                <select class="form-control" name="category" id="category">
                                  ...
                                  <?php
							      $quiz = "SHOW TABLES WHERE Tables_in_quiz != 'users'";
									$i=0;
									$quizList = mysql_query($quiz) or die(mysql_error());
									while($row = mysql_fetch_array($quizList)){
									echo "<option value='$row[Tables_in_quiz]'>$row[Tables_in_quiz]</option>";
